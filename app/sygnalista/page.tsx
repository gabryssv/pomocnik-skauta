...
const skills = [
  {
    category: "Komunikacja i sygnalizacja",
    items: [
      "ustalenie sygnałów morsem lub inny szyfr znany tylko dla zastępu",
      "przeprowadzenie gry sygnalizacyjnej gwizdkiem oraz światłem",
      "ćwiczenie przekazywania sygnałów morsem",
      "ćwiczenie siatki alarmowej zastępu",
    ],
  },
  {
    category: "Przekazywanie informacji",
    items: [
      "praktyczny kurs z tego jak sprawniej przekazywać informacje w zastępie",
      "gesty niewerbalne a werbalne",
      "mowa ciała - co nam mówi?",
      "ćwiczenie przekazywania informacji w praktyce, czyli gra z szyfrów",
    ],
  },
  {
    category: "Szyfry i kody",
    items: [
      "szyfr Cezara",
      "szyfr semafor",
      "na czym polegał szyfr Enigma i jak jego odszyfrowanie zmieniło oblicza wojny",
    ],
  },
]
      ...
      <div className="container mx-auto px-4 py-8">
        <div className="mb-8">
          ...
          <div className="flex items-center gap-4 mb-4" data-aos="fade-left">
            ...
            <div>
              <h1 className="text-4xl font-bold text-white">Sygnalista</h1>
              <p className="text-neutral-400">Komunikacja, szyfry, sygnalizacja i przekazywanie informacji</p>
            </div>
          </div>
          ...
          <Card className="bg-neutral-950 border-neutral-800 max-w-2xl mx-auto">
            <CardContent className="pt-6">
              <p className="text-neutral-400 mb-4">
                Sygnalista to kluczowa funkcja w zastępie, odpowiedzialna za sprawną komunikację i przekazywanie
                informacji w każdych warunkach.
              </p>
              <Link href="/">
